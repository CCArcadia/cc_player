...
local speakers = { peripheral.find("speaker") } -- this way i can utilyze ALL speakers
...
local function createMusicDirectory()
    if not fs.exists(musicDir) then
        print("Missing Disk. Please, insert Disk and Restart.")
...
local function runInitialSetup()
	...
	print("Use /disk/ folder created for music storage.")
	print("SERVER INTEGRATION ONLY. WIP")
	print("Sub folders are allowed for organization")
	print()
	print("--Valen")
	os.sleep(5)
	error()
...
-- This is the function that i took from someone elses code
